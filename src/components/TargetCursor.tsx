...
const TargetCursor: React.FC<TargetCursorProps> = ({ targetSelector = ".cursor-target", spinDuration = 2, hideDefaultCursor = true, hoverDuration = 0.2, parallaxOn = true }) => {
  ...
  useEffect(() => {
    if (isMobile || !cursorRef.current || typeof window === "undefined" || typeof document === "undefined") return;

    const originalCursor = document.body.style.cursor;
    // Always hide cursor when TargetCursor is active
